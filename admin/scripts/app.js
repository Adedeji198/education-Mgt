...
$(function(){
	...
	$('#menu li a').click(function(e){
		...
		$('.pull-right li a').hover(function(){
		return false;
	})
	...
	$('.pull-right li a').click(function(e){
		var li = $(this).parent();
		if(li.find('.dropdown-menu').length){
			e.preventDefault();
			if(li.hasClass('open')){
				...
				$('.pull-right li').removeClass('open');
				li.addClass('open');
			}
		}
	})
	...
	$(function(){
	$('.container-fluid.container-main').attr('class','container-main');
	document.getElementsByTagName("body")[0].className="page-header-fixed";
	})
